using LabsProject.BackEnd.Domain.Exceptions;
using System;
using System.Collections.Generic;
using System.Linq;

namespace LabsProject.BackEnd.Domain.ValueObjects
{
    public class State : Enumeration
    {
        ...
        public static State FromName(string name)
        {
            ...
            if (state == null)
            {
                throw new LabsProjectDomainException($"Possible values for State: {String.Join(",", List().Select(s => s.Name))}");
            }
